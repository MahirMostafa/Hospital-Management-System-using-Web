...
if(isset($_POST['submit']))
{
  ...
  while (($data = fgets($file)) !== false) {
    $temp = explode('|', $data);
    if ($name === trim($temp[0]) && $phone === trim($temp[1]) &&  $email === trim($temp[3])) 
    {
      $valid = true;
     break;
    }
  ...
  else 
  {
    ...
    $alldetailsarr= array($name,$phone,$nid,$email,$dob,$gender,$pass,$address);
                
                
    $details= $alldetailsarr[0] . "|" .  $alldetailsarr[1] . "|" . $alldetailsarr[2] . "|" . 
              $alldetailsarr[3] . "|" . $alldetailsarr[4] . "|".  $alldetailsarr[5] . "|" .
              $alldetailsarr[6] . "|" . $alldetailsarr[7] . "\r\n" ;            
