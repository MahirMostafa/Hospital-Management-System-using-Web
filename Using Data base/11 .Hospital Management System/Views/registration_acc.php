<?php require_once('../Controllers/regi_control_acc.php');?>
<!DOCTYPE html>
<html lang="eng">
    <head>
                ...
                <tr>
                    <td>
                        <nav> 
                            <h3><b>
                            <center>
                            <h2><b> Accountant Registration </b> </h2> 
                            </center>
                            </b></h3>
                        </nav>
                    </td>
                         ...
                         <fieldset>
                            ...
                            <table align="center">
                                ...
                                <tr>
                                    ...
                                    <td  style="color:red;"> <?php echo $dojErr ; ?> </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td  style="color:red;"> <?php echo $salErr ; ?> </td>
                                </tr>                                  
                                 <tr>
                                    <td></td>
