...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    {
        if(file_exists("../Uploads/pharmacists/" . $_FILES['pic']['name']))
        {
...
if(isset($_POST['submit']))
{
    ...
    {
        $status= pharma_add($name, $email, $pass , $nid , $phone , $gender , $address , $dob , $pic , $doj , $salary);
        
        if($status)
        {   
            $src= $_FILES['pic']['tmp_name'];
            $des = '../Uploads/pharmacists/'.$_FILES['pic']['name'];
