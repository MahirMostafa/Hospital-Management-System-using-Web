...
$name = $phone = $nid = $email = $dob = $address =  $pass = $gender = $pic = $salary = $doj = $salary = $doj = "";
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    {
        if(file_exists("../Uploads/pathologists/" . $_FILES['pic']['name']))
        {
...
if(isset($_POST['submit']))
{
    ...
    {
        $status= patho_add($name, $email, $pass , $nid , $phone , $gender , $address , $dob , $pic , $doj , $salary , $doj , $salary);
        
        if($status)
        {   
            $src= $_FILES['pic']['tmp_name'];
            $des = '../Uploads/pathologists/'.$_FILES['pic']['name'];
