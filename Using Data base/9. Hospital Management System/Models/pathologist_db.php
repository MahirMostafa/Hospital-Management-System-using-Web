...
function  patho_add($name, $email, $pass , $nid , $phone , $gender , $address , $dob , $pic ,$doj ,$salary)
{
    $con = getConnection() ;
    $insert_query = "INSERT INTO pathologist (uname, email, password, nid , phone , gender , address , dob , pic , joindate , salary) 
...
{
    $con = getConnection() ;
    $view_query = "SELECT uname ,email , salary  FROM pathologist" ;
