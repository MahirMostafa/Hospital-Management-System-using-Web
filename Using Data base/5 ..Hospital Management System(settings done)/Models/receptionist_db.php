...
function recep_add($name, $email, $pass , $nid , $phone , $gender , $address , $dob ,$pic)
{
    $con = getConnection() ;
    $insert_query = "INSERT INTO receptionist (uname, email, password, nid , phone , gender , address , dob , pic ) 
